import { FEATURES_CONTENT } from "@/features/landing/constants/landingContent";

const Features = () => {
  return (
    <div
      id="features"
      className="flex flex-col md:flex-row max-w-7xl mx-auto gap-8 py-8 md:py-16 px-4 sm:px-8"
    >
